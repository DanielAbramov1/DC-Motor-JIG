...
motor_controller dc_motor_1;
uint16_t adc_buffer[4]; //0-3 sensors HW configuration. 3 is dc motor

led_controller led_indicator;

char buf[511]; //uart buff for messaging
